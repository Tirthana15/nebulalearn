    ...
    <script>
        ...
        document.getElementById('grade-form').addEventListener('submit', function(e) {
            ...
            const formData = {
                ...
                assignment_id: document.getElementById('grade-assignment-id').value,
                student_id: document.getElementById('grade-student-id').value,
                grade: document.getElementById('grade-value').value
            };
            
            const submissionId = formData.submission_id;
            ...
            .then(data => {
                if (data.success) {
                    // Close modal and refresh the submissions list
                    document.getElementById('grade-modal').style.display = 'none';
                    alert('Grade saved successfully!');
                    document.getElementById('grades-assignment-filter').dispatchEvent(new Event('change'));
                } else {
                    console.error('Error details:', data);
                    alert(data.message || 'Error saving grade. Check console for details.');
                }
            })
            .catch(error => {
